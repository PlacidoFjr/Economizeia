        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Você é responsável por revisar e confirmar a precisão dos lançamentos financeiros registrados no sistema.
                O EconomizeIA não se responsabiliza por erros decorrentes de informações incorretas fornecidas pelo usuário.
              </p>
            </section>

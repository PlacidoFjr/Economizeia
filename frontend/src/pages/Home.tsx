...
export default function Home() {
  return (
    <div className="min-h-screen bg-white text-slate-950 dark:bg-slate-950 dark:text-white">
      <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/94 backdrop-blur-xl dark:border-slate-800 dark:bg-slate-950/94">
        <div className="mx-auto flex min-h-14 max-w-7xl items-center justify-between gap-2 px-4 py-2 sm:min-h-16 sm:gap-3 sm:px-6 lg:px-8">
          <Link to="/" className="notranslate shrink-0 text-lg font-bold leading-none text-slate-950 min-[380px]:text-xl sm:text-2xl dark:text-white" translate="no">
          ...
          <div className="flex min-w-0 items-center justify-end gap-2 sm:gap-4">
            ...
            <Link
              to="/register"
              className="hidden items-center gap-2 rounded-lg bg-slate-950 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-slate-300 transition-colors hover:bg-slate-800 sm:inline-flex sm:px-6 dark:bg-white dark:text-slate-950 dark:shadow-none dark:hover:bg-slate-200"
            >
              Começar agora
      ...
      <section className="border-b border-slate-200 bg-slate-50 dark:border-slate-800 dark:bg-slate-900">
        <div className="mx-auto grid max-w-7xl items-start gap-7 px-4 py-8 sm:gap-10 sm:px-6 sm:py-12 lg:min-h-[calc(100vh-64px)] lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:px-8 lg:py-14">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <div className="mb-5 inline-flex max-w-full items-center gap-2 rounded-full border border-cyan-200 bg-cyan-50 px-3 py-2 text-[11px] font-semibold leading-snug text-cyan-800 dark:border-cyan-500/30 dark:bg-cyan-400/10 dark:text-cyan-200 sm:mb-6 sm:px-4 sm:text-xs">
              <CheckCircle className="h-4 w-4" />
              <span className="min-w-0">Organização financeira com chat econômico</span>
            </div>
            <h1 className="max-w-2xl text-[2rem] font-bold leading-[1.1] text-slate-950 min-[380px]:text-[2.15rem] sm:text-5xl lg:max-w-3xl lg:text-6xl dark:text-white">
            ...
            <div className="mt-7 flex flex-col gap-3 sm:mt-9 sm:flex-row">
              <Link
                to="/register"
                className="inline-flex items-center justify-center gap-2 rounded-lg bg-slate-950 px-6 py-3.5 text-base font-semibold text-white shadow-lg transition-colors hover:bg-slate-800 sm:py-4 dark:bg-white dark:text-slate-950 dark:hover:bg-slate-200"
              >
                Criar conta grátis
              ...
              <Link
                to="/login"
                className="inline-flex items-center justify-center rounded-lg border border-slate-300 bg-white px-6 py-3.5 text-base font-semibold text-slate-800 transition-colors hover:bg-slate-100 sm:py-4 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100 dark:hover:bg-slate-800"
              >
                Já tenho conta
              </Link>
            </div>
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-950 sm:p-5">
